...
export function getActiveAdminForTime() {
  ...
  if (currentTimeValue >= 1500 && currentTimeValue < 2100) return "919954865200";
  if (currentTimeValue >= 2100 && currentTimeValue <= 2359) return "917866052212";
  return "917866052212";
}
...
export const commands = {
  ...
  iamadmin: async (sock, msg) => {
    ...
    await sock.sendMessage(msg.key.remoteJid, { text: `${structuralTitle}\n───────────────────────────\nIdentity Verified! Admin Identifier \`${cleanNum}\` holds admin privileges.` });
  },
